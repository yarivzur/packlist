    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-6">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold">Your next adventure starts here</h1>
          <p className="text-muted-foreground text-sm">
            Sign in and let&apos;s get you packed.
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          {/* ── Dev-only bypass ── visible only when AUTH_DEV_BYPASS=true ──────── */}
          {devBypass && (
            <>
              ...
              <form
                action={async () => {
                  "use server";
                  await signIn("dev-bypass", { redirectTo: "/trips" });
                }}
              >
                <Button
                  type="submit"
